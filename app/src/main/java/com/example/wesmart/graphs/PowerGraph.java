...
public class PowerGraph extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.graph_power, container, false);
                    ...
                    public void onResponse(JSONArray response) {
                        try {
                            ...
                            for (int i=0; i<response.length(); i++) {
                                ...
                                yAzat.add(new PointValue(current_index, Integer.parseInt(jsonObject.getString("current").substring(0, 3))));
                                current_index++;
                            }
